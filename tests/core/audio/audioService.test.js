...
describe("AudioService", () => {
  ...
  beforeEach(async () => {
    ...
    tracked = createTrackedMockAudioContext(vi);
    mockAudioContext = tracked.mockAudioContext;
    attachAudioContextToWindow(global.window, mockAudioContext);
  ...
  describe("Sound Playback", () => {
    ...
    it("should play placement sound", () => {
      ...
      expect(mockAudioContext.createBufferSource).toHaveBeenCalled();
      expect(tracked.mockBufferSource.start).toHaveBeenCalled();
    });
