import { describe, it, expect, beforeEach, vi, afterEach, setupGame, mockPerformanceAPI } from "../../helpers/setup.js";
...
describe("Performance Class Functionality", () => {
  ...
  beforeEach(async () => {
    ...
    restorePerformance = mockPerformanceAPI(vi, { stepMs: 10 });
