...
import fs from 'fs';
import { describe, it, expect, beforeEach, afterEach, vi, createServiceWorkerTestMocks } from '../../helpers/setup.js';
...
describe('Service Worker Integration Tests', () => {
    ...
    beforeEach(() => {
        vi.clearAllMocks();
        swMocks = createServiceWorkerTestMocks(vi);
        swMocks.applyGlobals();
    });
    ...
    describe('Service Worker Integration Tests', () => {
        ...
        it('should handle service worker update flow', async () => {
            ...
            swMocks.mockServiceWorkerRegistration.addEventListener = vi.fn();

            swMocks.mockServiceWorkerRegistration.addEventListener('updatefound', vi.fn());

            const registration = await navigator.serviceWorker.register('/sw.js');
            expect(registration).toBeDefined();

            expect(swMocks.mockServiceWorkerRegistration.addEventListener).toHaveBeenCalled();
        });
