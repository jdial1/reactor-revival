import { describe, it, expect, beforeEach, afterEach, vi, setupGameWithDOM, mockHardwareAPIs } from "../../helpers/setup.js";
import {
  ZOOM_SCALE_MIN,
  ZOOM_SCALE_MAX,
...
describe("Group 14: Mobile Gestures, Haptics and Wake Lock", () => {
  ...
  it("acquires wake lock when visible and skips when document is hidden", async () => {
    ...
    try {
      ...
      expect(hw.wakeLockRequest).toHaveBeenCalledWith("screen");
