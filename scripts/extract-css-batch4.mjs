...
const FEATURES = [
  {
    file: "utilities.css",
    sources: ["main.css"],
    patterns: [/^\.hidden$/, /^\.mobile-only$/, /^\.desktop-only$/, /^\.part-details$/],
  },
  {
    file: "typography.css",
    sources: ["main.css"],
  ...
  },
  {
    ...
    patterns: [
      ...
      ".objectives-chapter-info",
      ".chapter-progress-container",
      ".objective-part-icon",
    ],
  },
  {
    file: "objectives-mobile.css",
    sources: ["objectives.css"],
    patterns: [
      ".mobile-objectives-container",
      ".objectives-content-panel",
      ".objectives-toggle-btn",
      ".objectives-dismiss-btn",
    ],
  },
  {
    file: "branding.css",
  ...
  },
  {
    ...
    sources: ["splash.css"],
    merge: true,
    patterns: [".splash-mute-btn", ".splash-mute-icon", ".splash-mute-led", ".splash-mute-label"],
  },
  {
    file: "bios-forms.css",
    sources: ["game-setup.css"],
    patterns: [
      /\.bios-(input|step|param|preset|title|details|params|screen|content|overlay|input-wrap)/,
      /\.game-setup-selection \.bios-/,
      /\.doctrine-selection \.bios-/,
      /\.difficulty-selection \.bios-/,
      /\.setup-section \.bios-/,
      "@keyframes cursor-blink",
    ],
  },
  {
    file: "setup-cards.css",
    sources: ["game-setup.css"],
    patterns: [
      /\.doctrine-card/,
      /\.doctrine-cards/,
