    ...
    render(html`
      <div class="welcome-back-modal pixel-panel">
        ...
        <div class="welcome-back-actions">
          <button type="button" class="pixel-btn welcome-back-instant" @click=${() => this.hide("instant")}>Instant Catch-up</button>
          <button type="button" class="pixel-btn welcome-back-ff" @click=${() => this.hide("fast-forward")}>Fast-Forward</button>
        </div>
