...
export function applyComputedModifiers(game, opts = {}) {
  ...
  const directKeys = [
    ...
    "volatile_tuning_max", "plating_transfer_rate", "decompression_enabled", "reflector_cooling_factor"
  ];
...
export class Engine {
  ...
  _useWorker() {
    ...
    if (this.game.rows * this.game.cols >= GRID_SIZE_PHYSICS_WORKER_MAX_CELLS) return false;
    return true;
  }
