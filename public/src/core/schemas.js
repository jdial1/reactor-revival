...
const TechTreeSchema = z.array(TechTreeDoctrineSchema);
...
const ObjectiveListSchema = z.array(ObjectiveDefinitionSchema);
...
const NumericToNumber = DecimalLike.transform((v) => (v != null && v !== "" ? toDecimal(v).toNumber() : undefined));
...
const SaveDataSchema = z.preprocess((raw) => {
  ...
  total_exotic_particles: SaveDecimalSchema.optional().default(toDecimal(0)),
  exotic_particles: SaveDecimalSchema.optional().default(toDecimal(0)),
  current_exotic_particles: SaveDecimalSchema.optional().default(toDecimal(0)),
  reality_flux: SaveDecimalSchema.optional().default(toDecimal(0)),
...
const GameLoopReactorStateSchema = z.object({
  current_heat: z.number().optional().default(0),
  current_power: z.number().optional().default(0),
...
const GameLoopTickInputSchema = z.object({
  type: z.literal("tick"),
...
const GameLoopTickResultSchema = z.object({
...
const PhysicsTickInputSchema = z.object({
  heatBuffer: ArrayBufferLike,
...
const PhysicsTickResultSchema = z.object({
  reactorHeat: z.number().optional().default(0),
...
const GameDimensionsSchema = z.object({
